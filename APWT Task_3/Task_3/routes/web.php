...
//Delivaryman
Route::get('delivaryman/delivarymanWelcome', [PagesController::class,'delivarymanWelcome'])->name('delivarymanWelcome')->middleware('ValidAdmin');
...
//Sells Man
Route::get('sells_man/sells_manWelcome', [PagesController::class,'sells_manWelcome'])->name('sells_manWelcome');//->middleware('ValidSellsman');
// Route::get('/signout',[LoginController::class,'signout'])->name('signout');

// Route::get('sellsmanlogin/list',[LoginController::class,'login'])->name('login');
// Route::post('sellsmanlogin/list',[LoginController::class,'loginSubmit'])->name('login');
// Route::get('/sellsmanlogin/list',[LoginController::class,'logout'])->name('logout');
